// #![doc(html_root_url = "https://docs.rs/essembly-time/0.1.0-alpha.1")]
// #![warn(
...
//! Utilities for tracking timed events.
//!
//! This crate provides a number of utilities for working with times:
//!
